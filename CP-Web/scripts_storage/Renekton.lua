...
function Renekton:__init() -- initialize Renekton script
    ...
    self.ERange = 450 -- (450 is the actual radius w/ aoe 15 less)

    self.ESpeed = 760 + myHero.MovementSpeed
...
--    self.RRange = 175 -- R range is 400(activate since using target.position it will be used perfectly)
    ...
    self.ScriptVersion = "         dRenekton Ver: 1.03 CREDITS Derang3d" -- tells what version of the script it is.
