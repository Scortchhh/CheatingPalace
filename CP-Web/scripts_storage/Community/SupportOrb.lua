...
function Orbwalker:SaveSettings()
    SettingsManager:CreateSettings("SupportOrb")
    ...
    --SettingsManager:AddSettingsFloat("SupportMode", self.SupportMode.Value)
    ------------------------------------------------------------
...
function Orbwalker:LoadSettings()
    SettingsManager:GetSettingsFile("SupportOrb")
    ...
    --self.SupportMode.Value = SettingsManager:GetSettingsFloat("Slider", "SupportMode")
    -------------------------------------------------------------
...
function Orbwalker:GetTarget(OrbMode, Range)
    ...
    if OrbMode == "Harass" then
        ...
        --for I, Minion in ipairs(Minions) do
            --if self.SupportMode.Value then return end
