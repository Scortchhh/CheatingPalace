...
function Kindred:__init()
    ...
    self.ScriptVersion = "          --CCKindred Version: 0.515-- ///Credits to Scortch and Christoph///"
    ...
    self.DrawJungleMark         = self.KindredDrawings:AddCheckbox("Track Jungle mark", 1)
...
function Kindred:DrawJungleTimer()
    ...
    if self.DrawJungleMark.Value == 1 then
        if myHero.BuffData:GetBuff("kindredhitlistmonsteractivetracker").Valid then return end print("3")
        MarkTimer = "Offline" print("4")
    end

    if myHero.BuffData:GetBuff("kindredhitlistmonsteractivetracker").Valid then print("1")
        MarkTimer = "Online" print("2")
    end

    DrawMarkTimer = "JungleMark Is: " .. MarkTimer

    Render:DrawString(DrawMarkTimer, 850, 50, 92, 255, 5, 255)
end
