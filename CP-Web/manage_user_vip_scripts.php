        ...
        ?>
            ...
            <?php 
                ...
                if($endSubScript == "") {
                    ...
                    echo '<input class="form-control mt-2" type="date" disabled value="'. date("Y-m-d", strtotime($date)) .'">';
                    echo '<input class="form-control mt-2" name="newEndDate" type="date" value="'. date("Y-m-d", strtotime($date)) .'">';
                } else {
